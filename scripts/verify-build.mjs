...
const stage = join(tmpdir(), "closed-loop-tuning-verify-build");
...
// first (build.bat's own build lands it there too), or release.yml's later `plugin/ClosedLoopTuning-*.zip`
