	...
	<v-container fluid class="pa-2">
		...
		<v-row dense class="mt-1" align="start">
			...
			<v-col cols="12" md="3">
				...
				<v-card v-if="tuneSession?.envelopeCheck" class="mb-2" :variant="tuneSession.envelopeCheck.outcome === 'holds' ? 'flat' : 'tonal'" :color="tuneSession.envelopeCheck.outcome === 'saturates' ? 'warning' : undefined">
					<v-card-text class="py-3">
						<div class="d-flex align-center mb-1">
							<v-icon class="mr-2" :color="tuneSession.envelopeCheck.outcome === 'holds' ? 'success' : tuneSession.envelopeCheck.outcome === 'saturates' ? 'warning' : 'medium-emphasis'">{{ tuneSession.envelopeCheck.outcome === 'holds' ? "mdi-check-circle" : tuneSession.envelopeCheck.outcome === 'saturates' ? "mdi-alert" : "mdi-help-circle-outline" }}</v-icon>
				...
				<v-card v-if="tuneSession?.identifiedAtSeed" class="mb-2" variant="tonal" color="warning">
					<v-card-text class="py-3">
						<div class="d-flex align-center mb-1">
